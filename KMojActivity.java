...
public class KMojActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(KMojActivity.this).load(ContextCompat.getDrawable(this, R.drawable.moj0)).into(help1);

        Glide.with(KMojActivity.this).load(R.drawable.moj1).into(help2);

        Glide.with(KMojActivity.this).load(R.drawable.moj2).into(help3);
